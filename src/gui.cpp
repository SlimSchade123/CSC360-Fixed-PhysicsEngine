...
void GUI::Draw()
{
	...
	{
		physicsWindowBoxActive = !GuiWindowBox(Rectangle{ anchor01.x + 0, anchor01.y + 0, 312, 480 }, "Physics");
		GuiToggle(Rectangle{ anchor01.x + 96, anchor01.y + 424, 120, 24 }, "Simulate", &World::simulate);
		GuiToggle(Rectangle{ anchor01.x + 96, anchor01.y + 450, 120, 24 }, "Reset", &World::reset);
		...
		GuiGroupBox(Rectangle{ anchor04.x + 0, anchor04.y + 0, 256, 85 }, "World");
		...
		GuiSlider(Rectangle{ anchor04.x + 96, anchor04.y + 60, 120, 16 }, "Stiffness X", GUI_DATA(World::springStiffnessMult), -20, 20);
